...
export default class Header extends Component {
  Slideshow() {
    const ads = [`url(./images/Ads/delivery.jpg)`, `url(./images/Ads/catering.jpg)`, `url(./images/Ads/flavors.png)`];
    const delay = 2500;
    ...
    return (
      ...
      <div className="slideshow">
        ...
        <div className="about-container">
          <img className="profile-picture" alt="lollicup logo" src={require("./images/lollicup-logo.png")}/>
